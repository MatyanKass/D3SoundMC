...
public enum D3Preset {
	 ...
	 */
	REALISTIC_HIGH("realistic_high", 0, 60, 90, true, true, true, 100, 0, 100, true, 100, 0, 0, 0, 100),

	/**
	 * Та же физика, но в вдвое меньший процессор: все механизмы на месте,
	 * просто лучей меньше и картина грубее.
	 */
	REALISTIC_LOW("realistic_low", 0, 18, 60, true, true, true, 100, 0, 100, true, 100, 0, 0, 0, 100),

	/** Значения по умолчанию: всё включено, процессора берётся умеренно. */
	BALANCED("balanced", 0, 40, 70, true, true, true, 100, 0, 100, true, 100, 0, 0, 0, 100),
	 ...
	 */
	PERFORMANCE("performance", 20, 8, 50, true, false, false, 100, 0, 100, true, 100, 12, 220, 6, 100),
	 ...
	 * игровых движков.
	 */
	CINEMATIC("cinematic", 0, 50, 85, true, true, true, 60, 130, 115, true, 60, 0, 0, 0, 80);
	...
	/** 0 — сколько источников считать честно, пусть решает движок. */
	public final int maxSources;
	public final int diffractionLevel;
	...
	D3Preset(String key, int quality, int cpuShare, int cpuHeadroom,
	         ...
	         int maxSources, int diffractionLevel) {
		this.key = key;
		...
		this.diffractionLevel = diffractionLevel;
	}
	...
	public void applyTo(D3Config config) {
		...
		config.diffractionLevel = diffractionLevel;
	}
