...
public final class Air {
	...
	/**
	 * Что теряет звук на пути в ухо, когда голова под водой, дБ по полосам.
	 *
	 * Сама вода звук почти не гасит — наоборот, несёт его дальше воздуха.
	 * Глухо под водой звучит не среда, а слушатель: ушной канал залит, воздушной
	 * прослойки нет, и согласование сопротивлений, ради которого устроено
	 * среднее ухо, перестаёт работать. До перепонки доходит в основном то, что
	 * проводит череп, а это низ. Поэтому под водой всё звучит как из-за стены,
	 * даже если источник в шаге от вас.
	 */
	public static final float[] SUBMERGED_EAR_DB = {3f, 5f, 9f, 14f, 20f, 27f, 34f};

	/** То же в лаве: среда вязкая, верха не остаётся вовсе. */
	public static final float[] MOLTEN_EAR_DB = {5f, 8f, 14f, 20f, 28f, 36f, 45f};
