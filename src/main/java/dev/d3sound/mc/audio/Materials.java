...
public enum Materials {
	...
	// листва почти ничего не отражает: звук уходит вглубь кроны и рассеивается
	// на тысяче мелких листьев, назад приходят единицы процентов энергии
	FOLIAGE ("листва",  new float[]{0.55f, 0.70f, 0.85f, 0.92f, 0.95f, 0.96f, 0.96f},
	                    new float[]{0.75f, 0.80f, 0.85f, 0.90f, 0.92f, 0.95f, 0.95f},
	...
	/**
	 * Какую долю своей клетки материал занимает на самом деле.
	 *
	 * Блок листвы — это ветки и просветы, а не сплошная стена: звук проходит
	 * сквозь крону почти свободно, поэтому между деревьями не должно быть эха.
	 */
